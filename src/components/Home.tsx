...
export default function Home({setElementos,elementos}:HomeProops) {    
  ...
  return (
    <>  
        <div className="max-w-6xl mx-auto p-5 bgSecundary rounded-full pb-24">
            ...
            <div className="flex mt-10 justify-center space-x-4">
                <button className="bg-gray-800 text-white rounded-2xl w-60 p-2 hover:bg-gray-700">Empieza ya</button>
                <button className="border border-gray-50 text-white rounded-2xl w-60 p-2 hover:bg-slate-300">Ver mas</button>
            </div>
        </div>
            ...
            <div className="mt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 box" ref={boxRef}>
                    {ListaDeFunciones.map((funcion, index) => (
                        <div key={index} className=" justify-center bg-gradient-to-r from-slate-800 to-gray-800 p-5 
                        rounded-xl hover:scale-105 duration-300 hover:from-sky-800 hover:to-blue-800 flex flex-col">
                            <div className='flex-grow'>
                                <img src={`/${funcion.img}`} alt={funcion.name} className='max-w-32 max-h-32 mx-auto'/>
        ...
        <div className='max-w-4xl mx-auto mt-10 mb-20 boxCreadores' ref={boxCreators}>
            ...
            {datos.map((data,index) => (
                <div key={index} className='mt-10 bg-gradient-to-r from-slate-800 to-gray-800 p-5 
                            rounded-xl border border-slate-600 grid gap-4 grid-cols-2'>
                    ...
                    <div className='flex items-center space-x-10 justify-end'>
                        <a href="https://github.com/Isva23" className='bg-gradient-to-r from-slate-400 to-gray-600 rounded-full p-3
                        hover:from-sky-800 hover:to-blue-800  hover: shadow-lg hover:shadow-sky-400 duration-300'>
                            <img src="/public/github.png" alt="github" className='w-8 h-8'/>
                        </a>
                        <a href="" className='bg-gradient-to-r from-slate-400 to-gray-600 rounded-full p-3
                        hover:from-sky-800 hover:to-blue-800  hover:shadow-lg hover:shadow-sky-400 duration-300'>
