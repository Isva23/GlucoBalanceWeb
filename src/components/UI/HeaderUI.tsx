...
export default function HeaderUI({setLogin}:HeaderUIProops) {
    ...
    const centerContent = (
        <div className="flex flex-wrap align-items-center gap-3 space-x-3">
            <button className="p-link inline-flex justify-content-center align-items-center 
            text-white h-3rem w-3rem rounded-full p-2 hover:bg-gray-600 transition-all transition-duration-200">
    ...
    return (
        <div className="card">
            <Toolbar start={startContent} center={centerContent} className="max-w-7xl mx-auto bg-transparent border-b-4 border-blue-800"/>
        </div>
    );
}
